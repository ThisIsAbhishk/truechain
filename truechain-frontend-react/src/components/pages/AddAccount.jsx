...
const AddAccount = () => {
    ...
    const uploadImage = async (image) => {
        ...
        axios.post("https://truechain-backend.onrender.com/upload/profile", data, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post('https://truechain-backend.onrender.com/addaccount', accountData,
                {
            ...
            const res2 = await axios.post('https://truechain-backend.onrender.com/addprofile', profileData,
                {
                    headers: {'Content-Type': 'application/json'},
                });
